...
import time
from duman_interfaces.action import DumanJointGoal, DumanPoseGoal
...
class CountUntilServerNode(Node):
    ...
    def goal_callback(self, goal_request: DumanJointGoal.Goal):
    ...
    def execute_callback(self, goal_handle : ServerGoalHandle):
        ...
        result = DumanJointGoal.Result()
        result.success = True
        result.message = "Succeeded"
        goal_handle.succeed()

    def joint_goal_reached(self, joint_goal):
        # returns true if the joint goal has been reached
        return 
