...
class MoveDumanLeft(Node):
    def __init__(self):
        ...
        self.left_transfer_position = [0.08, -0.18, 0.31, 1.57, -1.57, 1.57]

        self.right_grasp_position = [-0.025, -0.14, 0.29, -1.57, 1.57, 0.0]
        self.left_grasp_position = [0.025, -0.18, 0.31, 1.57, -1.57, 1.57]
