...
int main(int argc, char** argv)
{
  ...
  rviz_visual_tools::RvizVisualTools visual_tools("base", "planning_scene_ros_api_tutorial", node);
  visual_tools.loadRemoteControl();
  visual_tools.deleteAllMarkers();

  // ROS API
  // CREATE THE PUBLISHER TO PLANNING SCENE 
  // move group will subscribe and publish to diffs
  ...
  //MAKING THE OBJECT TO BE ATTACHED TO THE ARM AND DEFINING THE MESSAGE
  ...
  attached_object.touch_links = std::vector<std::string>{ "gripper_base", "gripper", "part_1_gear_2", "part_2_gear_2", "gripper_2" };
  ...
  //REMOVE THE OBJECT FROM SCENE AND ATTACH IT TO THE ROBOT
